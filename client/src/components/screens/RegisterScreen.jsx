...
const RegisterScreen = ({history}) => {
    ...
    const registerHandler = async (e) => {
        ...
        try {
            const {data} = await axios.post(`${baseURL}/api/auth/register`,{username,email,password},config)
    ...
    return (
        <div className="register-screen">
            <form onSubmit = {registerHandler}action="" className="register-screen__form">
